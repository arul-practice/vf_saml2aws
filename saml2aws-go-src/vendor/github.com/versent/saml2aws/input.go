...
func PromptForConfigurationDetails(idpAccount *cfg.IDPAccount) error {
	...
	// Need to correct this to work properly - possibly much bigger change than one liner
	//idpAccount.SessionDuration = strconv.ParseInt(prompter.String("Session Duration - maximum of 7200 = 2Hr", idpAccount.SessionDuration), 10, 64)
